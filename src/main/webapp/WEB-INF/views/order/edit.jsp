	...
	<main>
		...
		<div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
			<div
				...
				<h1 class="h2">Order 내역 수정</h1>
			</div>
			<form method="POST" action="/Socks/order/editok.do">
				<div
				...
				<table class="table border-top" id="add">
					...
					<tr>
						...
						<th colspan="5"><select name="period" id="period"
							class="form-select me-2">
								<option value="" disabled selected>${oredit.period}</option>
					...
					<tr>
						...
						<th colspan="5"><select name="product_code" id="product"
							class="form-select me-2">
								<option value="${oredit.product_code}" disabled selected>${oredit.product_name}&nbsp&nbsp${oredit.product_size}&nbsp&nbsp${oredit.product_color}</option>
